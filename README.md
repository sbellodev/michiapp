...
1. `git clone` este proxecto

2. Abrimos e executamos Docker paralelamente.

3. Abrimos o proxecto dende o noso IDE na carpeta raíz.

4. Ejecutar > Editar configuracions

5. Añadimos 2 configuracions de tipo maven
